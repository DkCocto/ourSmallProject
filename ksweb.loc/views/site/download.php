...
<div class="feature">
		...
		<div class="container">
			<div class="row">
                            ...
                            <?= Html::a('KSWEB v3.74', Url::to(['https://play.google.com/store/apps/details?id=ru.kslabs.ksweb']))?>
                            <br />
                            <?= Html::a('KSWEB v3.73', Url::to(['/download']))?>
                            <br />
                            <?= Html::a('KSWEB v3.72', Url::to(['/download']))?>
                            ...
                            <p>From our site:</p>
                            <?= Html::a('Schedule! v1.01', Url::to(['/download']))?>
                            <br />
